const Footer = {
  print() {
    return /* html */`
      <footer class="px-4 divide-y bg-[#172337] text-coolGray-800">
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div class="lg:w-1/3">
            <a href="#" class="flex justify-center space-x-3 lg:justify-start">
              <div class="flex items-center justify-center w-24 h-12 rounded-full bg-white-600">
          ...
          <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div class="space-y-3">
              <h3 class="tracking-wide uppercase text-white">Clothing</h3>
            ...
            <div class="space-y-3">
              <h3 class="tracking-wide uppercase text-white">Accessories</h3>
              <ul class="space-y-1 text-white">
                <li>
                  <a href="#">Watches</a>
                </li>
            ...
            <div class="space-y-3">
              <h3 class="uppercase text-white">Brands</h3>
              <ul class="space-y-1 text-white">
                <li>
            ...
            <div class="space-y-3">
              ...
              <div class="flex justify-start space-x-3 text-white">
