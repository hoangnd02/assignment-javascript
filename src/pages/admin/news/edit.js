                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                      <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-3">
                          ...
                          <input type="text" value="${findNews.title}" name="title" id="title" autocomplete="given-name" class="py-2 px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div class="mt-1">
                          <textarea id="content" name="content" rows="3" class="py-2 px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Content news">
                            ${findNews.desc}
                          </textarea>
                        </div>
                      </div>
